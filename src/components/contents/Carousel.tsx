...
const renderCarousel = carouselContent.map((carouselContent) => {
  return (
    <Box style={{ height: "92vh", minHeight: "92vh", backgroundColor: `${carouselContent.bg}`, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundPosition: "center" }}> {/*forimage*/}
