...
const renderServices = serviceContent.map((serviceContent) => {
  return (
    <Grid item xs={12} sm={6} md={6} lg={4} xl={4} sx={{ paddingY: "20px", minHeight: "100px", width: "100%", backgroundColor: `${serviceContent.bg}`, backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundPosition: "center" }}>
      <Container>
